...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str, default="./Dataset/test_data/beauty_test.csv")
    ...
    parser.add_argument('--max_samples', type=int, default=100, help='Maximum number of test samples to process (default: process all)')
